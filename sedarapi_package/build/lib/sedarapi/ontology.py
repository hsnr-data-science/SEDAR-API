...
#--------------------------------------------------------------
class Ontology:
    def __init__(self, connection: Type[Commons], workspace_id: str, ontology_id: str):
    ...
    def get_all_annotations(self) -> List[Annotation]:
        ...
        all_annotations = self._ontology_completion_search(self.workspace, search_term="")
