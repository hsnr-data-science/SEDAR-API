...
class Attribute:
    #--------------------------------------------------------------
    def __init__(self, connection: Type[Commons], workspace_id: str, dataset_id: str, attribute_id: str):
    ...
    def update(self, description:str = None, datatype:str = None, is_pk: bool = None, is_fk: bool = None, contains_PII: bool = None) -> Attribute:
        """
        Updates the properties of the attribute.
    ...
    def create_foreign_key_construct(self, ontology: "Ontology", annotation: "Annotation", fk_dataset: "Dataset" = None, fk_attribute: "Attribute" = None, set_pk: bool = False) -> dict:
        ...
        Returns:
            Dict: A dictionary with the content of the server response representing the fk construct.

        Notes:
            - If no fk_dataset and no fk_attribute is given, there will just be created an annotation for the attribtue
