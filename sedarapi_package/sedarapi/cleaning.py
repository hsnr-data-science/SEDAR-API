...
class DatasetCleaning:
    #--------------------------------------------------------------
    def __init__(self, connection: Type[Commons], workspace_id: str, dataset_id: str, dataset_version: str):
    ...
    def get_constraint_suggestions(self) -> List[ConstraintSuggestion]:
        ...
        Returns:
            List[ConstraintSuggestions]: A list of constraint suggestions.
                ...
                The properties can be reached via the class members.
        ...
        Description:
            ...
            GET request to the '/api/v1/workspaces/{workspace_id}/datasets/{dataset_id}/constraint-suggestions' endpoint.
    ...
    def get_dataset_validations(self) -> dict:
        ...
        Description:
            ...
            `/api/v1/workspaces/{workspace_id}/datasets/{dataset_id}/validations`.
    ...
    def delete_dataset_validations(self) -> bool: # seems to be unfunctional, check serverside implementation # 
        ...
        Description:
            ...
            space. The method communicates with the API endpoint `/api/v1/workspaces/{workspace_id}/datasets/{dataset_id}/validations`.
    ...
    def validate_local_constraints(self) -> dict:
        ...
        Description:
            ...
            by sending a POST request to the '/api/v1/workspaces/{workspace_id}/datasets/{dataset_id}/constraints/validation' endpoint. 
    ...
    def get_filter_suggestions(self, add_to_local_filters=True) -> List[dict]:
        ...
        Description:
            ...
            by sending a GET request to the '/api/v1/workspaces/{workspace_id}/datasets/{dataset_id}/filters/suggestions' endpoint. 
    ...
    def execute_local_filters(self, datasource_definition: any) -> bool:
        ...
        Description:
            ...
            1. Sending a PUT request to the '/api/v1/workspaces/{workspace_id}/datasets/{dataset_id}/filters' endpoint.
...
#-------------------------------------------------------------------------
#----------------- Helper Class "ConstraintSuggestions" ------------------
#-------------------------------------------------------------------------
